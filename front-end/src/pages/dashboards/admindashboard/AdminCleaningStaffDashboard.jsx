...
export default function AdminCleaningDashboard() {
  ...
  const handleUpdate = async () => {
    try {
      await api.put(`/CleaningStaff/updateCleaningStaff/${editingStaffID}`, {
  ...
  const handleDeleteClick = async (id) => {
    ...
    try {
      await api.delete(`/CleaningStaff/deleteCleaningStaff/${id}`);
                  ...
                  <tr key={s.cleaningStaffID}>
                    ...
                    <td>
                      {editingStaffID === s.cleaningStaffID ? (
                        ...
                        <>
                          <button className="btn btn-sm btn-outline-dark me-2" onClick={() => handleEditClick(s)}>
                            <i className="bi bi-pencil"></i>
                          </button>
                          <button className="btn btn-sm btn-outline-danger" onClick={() => handleDeleteClick(s.cleaningStaffID)}>
