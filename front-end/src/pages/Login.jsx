    ...
    try {
      ...
      if (loginRes.data.isLoggedIn) {
        ...
        switch (role) {
          ...
          case "serviceManager":navigate ("/servicedashboard/servicemanagerdashboard"); break ;
          case "serviceRecepsionist": navigate ("/servicedashboard/servicerecepcionist"); break ;
          default:
